-- ============================================================================
-- CORREÇÃO URGENTE - Esquads Academy Database
-- Execute este SQL no Supabase Dashboard > SQL Editor
-- ============================================================================

-- 1. CRIAR TABELA MISSIONS
-- ============================================================================
...
BEGIN
  ...
  RAISE NOTICE '📊 Tabelas criadas: missions, user_missions, notifications';
  RAISE NOTICE '🔒 RLS habilitado em todas as tabelas';
  RAISE NOTICE '📝 Dados de teste inseridos';
  RAISE NOTICE '🎯 Sistema de missões pronto para uso!';
END $$;
