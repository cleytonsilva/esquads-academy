...
export default function Footer() {
  ...
  const footerColumnsStagger = useScrollRevealStagger<HTMLDivElement>(4, { delay: 0 }, 'staggered');
  const bottomSectionReveal = useScrollReveal<HTMLDivElement>({ delay: 400 }, 'default');
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-slate-600">
              © {currentYear} Esquads. Todos os direitos reservados.
            </p>
