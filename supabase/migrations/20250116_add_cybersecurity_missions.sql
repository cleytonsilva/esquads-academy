-- Migration: Adicionar missões específicas de cybersegurança
-- Data: 2025-01-16
...
VALUES ('20250116_add_cybersecurity_missions', NOW())
ON CONFLICT (name) DO NOTHING;

COMMIT;

-- Comentário final
COMMENT ON TABLE public.missions IS 'Tabela de missões incluindo missões específicas de cybersegurança - Migração 20250116_add_cybersecurity_missions aplicada';
